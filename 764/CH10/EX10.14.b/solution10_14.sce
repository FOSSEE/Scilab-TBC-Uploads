...
path = get_absolute_file_path('solution10_14.sce')
//Obtain path of data file
datapath = path + filesep() + 'data10_14.sci'
//Obtain path of function file
funcpath = path + filesep() + 'functions10_14.sci'
//Clear all
clc
...
deltamax = (8 * Pmax * (D^3) * N)/(G * (dmod^4))
