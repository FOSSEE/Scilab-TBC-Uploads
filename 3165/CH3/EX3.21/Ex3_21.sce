//Example 3-21
//Program to Pl o t Magni tude Responce o f g i v e n B.R. F .wi th s p e c i f i c a t i o n s :
...
hd(n)=( sin (0.7* %pi *(n-U)+sin(%pi*(n-U)/3))-sin (0.3* %pi *(n-U)/3))/( %pi *(n-U));
end
h(n)=hd(n)* win_l (n);
end
 [ hzm ,fr ]= frmag (h ,256) ;
...
title ( ' Fr equency Re spons e o f g i v e n BRF u s i n g Ka i s e r Window ' );
xgrid (2);
