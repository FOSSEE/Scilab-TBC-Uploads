...
y1 = (Mean1 - Mean2) - Z*sqrt( (std_dev1^2)/n1 + (std_dev2^2)/n2 )    // lower limit
y2 = (Mean1 - Mean2) + Z*sqrt( (std_dev1^2)/n1 + (std_dev2^2)/n2 )    // upper limit
...
// Result
printf ( "95%% large sample confidence interval(in thousand pounds per square): ( %.1f , %.1f)",m1,m2)
